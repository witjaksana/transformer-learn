...
class MultiHeadAttention(nn.Module):
    def __init__(self, d_model, num_heads):
        ...
        self.d_k = d_model // num_heads # dimension of each head's key, query and values
    ...
    def combine_heads(self, x):
        # combine multiple heads back to original
...
class Transformer(nn.Module):
    def __init__(self, src_vocab_size, tgt_vocab_size, d_model, num_heads, num_layers, d_ff, max_seq_lengtgh, dropout):
